...
def test_extracts_symbols_with_usdt_suffix(test_db_with_universe):
    ...
    symbols = get_binance_symbols_from_universe(
        db_path=test_db_with_universe, start_date="2024-01-01", end_date="2024-04-30", top_n=50
    )
...
def test_filters_by_rank_threshold(test_db_with_universe):
    ...
    symbols = get_binance_symbols_from_universe(
        db_path=test_db_with_universe, start_date="2024-01-01", end_date="2024-04-30", top_n=10
    )
...
def test_filters_by_date_range(test_db_with_universe):
    ...
    # Only January data
    symbols = get_binance_symbols_from_universe(
        db_path=test_db_with_universe, start_date="2024-01-01", end_date="2024-01-31", top_n=50
    )
...
def test_empty_universe_returns_empty_list(test_db_with_universe):
    ...
    symbols = get_binance_symbols_from_universe(
        db_path=test_db_with_universe, start_date="2025-01-01", end_date="2025-12-31", top_n=50
    )
